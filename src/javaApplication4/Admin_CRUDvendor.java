...
public class Admin_CRUDvendor extends javax.swing.JFrame {


    private FileManager fm;
    private String userFile = "src/resources/users.txt";
    public Admin_CRUDvendor() {
        initComponents();
    ...
    private void initComponents() {
        ...
        vendorCRUDbutton.setBackground(new java.awt.Color(247, 127, 0));
        ...
        label1.setText("Vendor Registration Approval");
...
//        loadUsersIntoTable();
        ...
        DefaultTableModel populatedModel = controller.populateUsersTableModel(User.Role.Vendor);
        vendorTable.setModel(populatedModel);
        ...
        DefaultTableModel model = (DefaultTableModel) vendorTable.getModel();
            ...
            try (BufferedReader br = new BufferedReader(new FileReader(f))) {
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    if (data.length >= 5 && data[4].equals("Vendor")){
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        try{
            int row;
            row = vendorTable.getSelectedRow();
            String id = vendorTable.getValueAt(row, 0).toString();
...
//            
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        if (selectedRow >= 0) {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                ...
                String userId = (String) vendorTable.getValueAt(selectedRow, 0);
                ...
                if (userRemoved) {
                    ...
                    ((DefaultTableModel) vendorTable.getModel()).removeRow(selectedRow);
    ...
    private void topupButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_topupButtonActionPerformed
        try{
            ...
            User user = fm.getUserById(idField.getText());  // Cast to vendor
...
private void clearFields() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_CRUDvendor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_CRUDvendor().setVisible(true);
            }
        });
    }
